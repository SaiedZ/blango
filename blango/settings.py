...
class Dev(Configuration):
    ...
    # And to go further aside, how would the above setting be read from an environment variable with Django Configurations?
    # You should use a SingleNestedTupleValue and set the environment variable like this
